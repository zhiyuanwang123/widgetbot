...
export interface UserConfig {
  ...
  express: {
    ...
    port: number
    // /**
    //  * Options for the Apollo GraphQL API
    //  */
    // apollo: {
    //   /**
    //    * (Optional) GraphQL monitoring and analytics
    //    *
    //    * get a token from https://engine.apollographql.com/
    //    */
    //   apiKey: string
    // }
    /**
  ...
  cache: {
    ...
    /**
     * How long to cache the members for each server for
     */
    'graphql.membersExpiration': string
    /**
